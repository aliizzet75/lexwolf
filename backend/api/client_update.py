...
RELEASE_NOTES = "Mandanten-Dropdown zeigt keine Eintraege - claude verify  Reproduktionsschritte: 1. Dialog oeffnen 2. Dropdown klicken Client-Version: 1.2.3 UI-Stelle: Mandanten-Liste  Screenshot: /attachments/8deed5"
